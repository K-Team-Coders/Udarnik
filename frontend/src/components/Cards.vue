<template>
    ...
    <div class="ml-4 rounded-md">
      ...
      <div class="mt-2 rounded-md outline outline-orange-100">
        <div class="flex bg-gray1 p-1 rounded-md">
          ...
          <button onclick="window.location.href = 'http://192.168.0.174:8080/#/mnemonic1'" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded-l">
    >
  </button>
        </div>
  ...
  <text transform="translate(242.887 112.309)" style="isolation: isolate;font-size: 4.7207136154174805px;fill: #595959;font-family: MSReferenceSansSerif, MS Reference Sans Serif">6</text>
          ...
          <p class="flex  justify-center bg-gray-100">Все подшипники</p>
